...
declare const DropdownMenuSubContent: $$__sveltets_2_IsomorphicComponent<$$__sveltets_2_PropsWithChildren<DropdownMenuPrimitive.ContentProps, {
    default: {};
}>, {
...
type DropdownMenuSubContent = InstanceType<typeof DropdownMenuSubContent>;
